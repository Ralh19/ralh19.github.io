...
<template>
  <section id="home"
    ...
    <container>
      <div class="flex flex-col items-start justify-center w-full max-w-8xl mx-auto relative"> <!-- max-w-8xl for even wider hero -->
        <!-- Hero content -->
        <div
          ...
          <div class="relative z-10 w-full">
            ...
            <div class="flex flex-row gap-8 mb-10">
              ...
              <a href="/docs/resume_fr.pdf" target="_blank"
                class="text-2xl px-10 py-5 bg-highlight-color text-white rounded-xl scale-animation hover:opacity-90 text-center flex items-center gap-4">
                <i class="bi bi-filetype-pdf text-2xl md:text-3xl"></i>
                {{ t('hero.resume') }}
              </a>
              <div class="flex items-center text-highlight-color mb-2">
                <i class="bi bi-geo-alt-fill text-3xl md:text-4xl bounce-animation"></i>
                <span class="text-xl md:text-2xl ml-3 dark:text-main-text-color-dark">{{ t('hero.location') }}</span>
              </div>
            </div>
          </div>
        </div>
